...
from .views import news_list, news_detail, homePageView, ContactPageView, errorPageView, aboutPageView, HomePageView, LocalNewsView, ForeignNewsView, TechnologyNewsView, SportNewsView
